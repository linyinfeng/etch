...
Both crate roots want the same header comment. Defining it once and referencing
it from two different root chunks is the whole point of tangling — the same text
in two places, written once:
